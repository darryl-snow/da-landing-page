...
-------------------------------------------------------------------------------------*/
	function FloatObject(jqObj, params)
	{
		...
		if( document.getElementById("divFloatingX"))
		{
		    this.currentX = $("#divFloatingX").offset().left;
		}
		else
		{
	...
	FloatObject.prototype.updateLocation = function()
	{
	    if( document.getElementById("divFloatingX"))
	    {
		    this.updatedX = $("#divFloatingX").offset().left;
		}
		else
		{
		...
		{
		    if( this.updatedX > this.maxX )
		        this.updatedX = this.maxX;
		}
